...
function PaletteStrip({ palette, width, height = 12 }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    Array.from({ length: n }, (_, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { flex: 1, background: interpolateColor(stops, i / (n - 1)) } }))
  );
}
...
const ScatterChart = forwardRef(function ScatterChart2({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("g", { clipPath: "url(#sc-clip)" }, refLines.map((rl) => {
      ...
      if (isH && (rl.value < yMin || rl.value > yMax) || !isH && (rl.value < xMin || rl.value > xMax))
        return null;
      return /* @__PURE__ */ React.createElement(
        "line",
        {
...
function AesBox({ theme, children }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { borderRadius: 10, border: `1.5px solid ${t.border}`, background: t.bg } }, /* @__PURE__ */ React.createElement("div", { style: { background: t.header, padding: "8px 14px", borderRadius: "8px 8px 0 0" } }, /* @__PURE__ */ React.createElement(
    "span",
    {
      style: {
        color: "#fff",
    ...
    t.label
  )), /* @__PURE__ */ React.createElement("div", { style: { padding: "12px 14px", minHeight: 40 } }, children));
}
function UploadStep({ sepOverride, setSepOverride, rawText, doParse, handleFileLoad }) {
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(
  ...
  ), /* @__PURE__ */ React.createElement("p", { style: { margin: "4px 0 12px", fontSize: 11, color: "#aaa", textAlign: "right" } }, "Max file size: 2 MB"), /* @__PURE__ */ React.createElement(
    "div",
    {
      style: {
        marginTop: 24,
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { color: "#fff", fontWeight: 700, fontSize: 15 } }, "Scatter Plot \u2014 How to use"), /* @__PURE__ */ React.createElement("div", { style: { color: "rgba(255,255,255,0.75)", fontSize: 11, marginTop: 2 } }, "Upload \u2192 Pick X & Y \u2192 Map color, size, shape"))
    ),
    /* @__PURE__ */ React.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("p", { style: { fontSize: 12, lineHeight: 1.75, color: "#444", margin: 0 } }, "One ", /* @__PURE__ */ React.createElement("strong", null, "row"), " = one data point. One ", /* @__PURE__ */ React.createElement("strong", null, "column"), " = one variable. Any number of columns, any mix of numeric and text.")
      ),
      /* @__PURE__ */ React.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ React.createElement("p", { style: { fontSize: 12, color: "#444", margin: 0, lineHeight: 1.6 } }, "After upload, pick any ", /* @__PURE__ */ React.createElement("strong", null, "numeric"), " column for ", /* @__PURE__ */ React.createElement("strong", null, "X"), " and", " ", /* @__PURE__ */ React.createElement("strong", null, "Y"), " via dropdowns. The plot updates instantly.")
      ),
      /* @__PURE__ */ React.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ React.createElement("p", { style: { fontSize: 12, color: "#444", margin: 0, lineHeight: 1.6 } }, "Map any column to ", /* @__PURE__ */ React.createElement("strong", null, "color"), ", ", /* @__PURE__ */ React.createElement("strong", null, "size"), ", or", " ", /* @__PURE__ */ React.createElement("strong", null, "shape"), ". Numeric columns get continuous scales; categorical columns get discrete legends.")
      ),
...
function PlotStep({
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 20, alignItems: "flex-start" } }, /* @__PURE__ */ React.createElement(
    "div",
    {
      style: {
        width: 328,
    ...
    /* @__PURE__ */ React.createElement("div", { style: { ...sec, padding: "10px 12px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#666", marginBottom: 4 } }, /* @__PURE__ */ React.createElement("strong", { style: { color: "#333" } }, fileName), /* @__PURE__ */ React.createElement("span", { style: { color: "#999", marginLeft: 6 } }, parsed.data.length, " rows \xB7 ", parsed.headers.length, " cols"))),
    /* @__PURE__ */ React.createElement(
      ActionsPanel,
      {
    ...
    ), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, marginTop: 4 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#777" } }, "Stroke"), /* @__PURE__ */ React.createElement(ColorInput, { value: strokeColor, onChange: setStrokeColor, size: 20 })), /* @__PURE__ */ React.createElement(
      SliderControl,
      {
        label: "Stroke width",
        value: strokeWidth,
    ...
    /* @__PURE__ */ React.createElement("div", { style: sec }, /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          display: "flex",
      ...
      /* @__PURE__ */ React.createElement("p", { style: { margin: 0, fontSize: 13, fontWeight: 600, color: "#555" } }, "Regression line"),
      /* @__PURE__ */ React.createElement(
        "label",
        {
          style: {
    ...
    ), regression.on && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, !regressionStats.valid && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#dc2626" } }, "Need \u2265 2 points with variation in X."), regressionStats.valid && /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          fontSize: 11,
      ...
      /* @__PURE__ */ React.createElement("div", null, "slope: ", /* @__PURE__ */ React.createElement("strong", null, fmtTick(regressionStats.slope))),
      /* @__PURE__ */ React.createElement("div", null, "intercept: ", /* @__PURE__ */ React.createElement("strong", null, fmtTick(regressionStats.intercept))),
      /* @__PURE__ */ React.createElement("div", null, "R\xB2: ", /* @__PURE__ */ React.createElement("strong", null, regressionStats.r2.toFixed(4)), " \xA0 n =", " ", regressionStats.n)
    ), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#777" } }, "Color"), /* @__PURE__ */ React.createElement(
      ColorInput,
      {
      ...
      "Show equation & R\xB2 on plot"
    ), regression.showStats && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Label position"), /* @__PURE__ */ React.createElement(
      "select",
      {
    ...
    /* @__PURE__ */ React.createElement(AesBox, { theme: "color" }, /* @__PURE__ */ React.createElement(
      ...
      Object.keys(COLOR_PALETTES).map((p) => /* @__PURE__ */ React.createElement("option", { key: p, value: p }, p))
    ), /* @__PURE__ */ React.createElement(PaletteStrip, { palette: colorMapPalette }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#aaa" } }, "range: ", fmtTick(colorMapRange[0]), " \u2192 ", fmtTick(colorMapRange[1]))), colorMapType === "discrete" && /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          display: "flex",
      ...
      colorMapCategories.map((cat, ci) => /* @__PURE__ */ React.createElement("div", { key: cat, style: { display: "flex", gap: 8, alignItems: "center" } }, /* @__PURE__ */ React.createElement(
        ColorInput,
        {
      ...
      ), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: "#333" } }, cat)))
    ))),
    /* @__PURE__ */ React.createElement(AesBox, { theme: "size" }, /* @__PURE__ */ React.createElement(
      "select",
      {
      ...
      /* @__PURE__ */ React.createElement("option", { value: "" }, "\u2014 None \u2014"),
      mappableCols.filter((i) => i !== colorMapCol && i !== shapeMapCol).map((i) => /* @__PURE__ */ React.createElement("option", { key: i, value: i }, parsed.headers[i]))
    ...
    ), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#aaa" } }, "range: ", fmtTick(sizeMapRange[0]), " \u2192 ", fmtTick(sizeMapRange[1]))), sizeMapType === "discrete" && /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          display: "flex",
    ...
    /* @__PURE__ */ React.createElement(AesBox, { theme: "shape" }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("option", { value: "" }, "\u2014 None \u2014"),
      mappableCols.filter((i) => i !== colorMapCol && i !== sizeMapCol).map((i) => /* @__PURE__ */ React.createElement("option", { key: i, value: i }, parsed.headers[i]))
    ), hasShapeMap && /* @__PURE__ */ React.createElement(React.Fragment, null, shapeWarning && /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          padding: "6px 10px",
      ...
      /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#dc2626" } }, shapeWarning)
    ), /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
      ...
      shapeMapCategories.map((cat, ci) => /* @__PURE__ */ React.createElement("div", { key: cat, style: { display: "flex", gap: 8, alignItems: "center" } }, /* @__PURE__ */ React.createElement(
        "select",
        {
    ...
    /* @__PURE__ */ React.createElement("div", { style: sec }, /* @__PURE__ */ React.createElement("p", { style: { margin: "0 0 10px", fontSize: 13, fontWeight: 600, color: "#555" } }, "Axes"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: lbl }, "X min"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "text",
        inputMode: "decimal",
    ...
    )), /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: lbl }, "X max"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "text",
        inputMode: "decimal",
    ...
    ))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Y min"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "text",
        inputMode: "decimal",
    ...
    )), /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Y max"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "text",
        inputMode: "decimal",
    ...
    ))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "X label"), /* @__PURE__ */ React.createElement(
      "input",
      {
        value: vis.xLabel,
    ...
    /* @__PURE__ */ React.createElement("div", { style: { ...sec, padding: 12, display: "flex", flexDirection: "column", gap: 8 } }, /* @__PURE__ */ React.createElement("p", { style: { margin: "0 0 4px", fontSize: 13, fontWeight: 600, color: "#555" } }, "Style"), /* @__PURE__ */ React.createElement(
      BaseStyleControls,
      {
        plotBg: vis.plotBg,
    ...
    /* @__PURE__ */ React.createElement("div", { style: sec }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("p", { style: { margin: 0, fontSize: 13, fontWeight: 600, color: "#555" } }, "Ref lines"),
      /* @__PURE__ */ React.createElement(
        "button",
        {
    ...
    ), refLines.length === 0 && /* @__PURE__ */ React.createElement("p", { style: { fontSize: 12, color: "#aaa" } }, "No reference lines."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, refLines.map((rl) => /* @__PURE__ */ React.createElement(
      "div",
      {
        key: rl.id,
        style: {
      ...
      rl.dashed && /* @__PURE__ */ React.createElement(
        "select",
        {
          value: rl.dashArray,
        ...
        /* @__PURE__ */ React.createElement("option", { value: "7,4" }, "\u2014 \u2014 \u2014"),
        /* @__PURE__ */ React.createElement("option", { value: "3,3" }, "\xB7 \xB7 \xB7 \xB7"),
        /* @__PURE__ */ React.createElement("option", { value: "12,4" }, "\u2014\u2014 \u2014\u2014"),
        /* @__PURE__ */ React.createElement("option", { value: "10,4,2,4" }, "\u2014 \xB7 \u2014 \xB7"),
        /* @__PURE__ */ React.createElement("option", { value: "2,2" }, "\xB7\xB7 \xB7\xB7")
      ),
      /* @__PURE__ */ React.createElement(
        "input",
        {
      ...
      rl.label && /* @__PURE__ */ React.createElement(
        "select",
        {
          value: rl.labelSide,
    ...
    filterableCols.length > 0 && /* @__PURE__ */ React.createElement("div", { style: sec }, /* @__PURE__ */ React.createElement(
    ...
    ), filtersOpen && /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          display: "flex",
      ...
      filterableCols.map((ci) => {
        ...
        return /* @__PURE__ */ React.createElement("div", { key: ci }, /* @__PURE__ */ React.createElement(
          "div",
          {
            style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 3 }
          },
          /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, fontWeight: 600, color: "#555" } }, parsed.headers[ci]),
          /* @__PURE__ */ React.createElement(
            "button",
            {
...
function App() {
  ...
  const addRefLine = (dir) => setRefLines((prev) => [
    ...prev,
    {
      id: ++refLineCounter,
      dir,
