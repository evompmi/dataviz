...
function computeCalStats(calData, headers, conditions) {
  ...
  return conditions.map((cond) => {
    ...
    for (let r = 0; r < nRows; r++) {
      ...
      means.push(m);
      sds.push(
        vals.length < 2 ? 0 : Math.sqrt(vals.reduce((a, v) => a + (v - m) ** 2, 0) / (vals.length - 1))
      );
    }
...
const Chart = forwardRef(function Chart2({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    plotSubtitle && /* @__PURE__ */ React.createElement(
      "text",
      {
        x: vbW / 2,
        y: plotTitle ? 34 : 17,
    ...
    /* @__PURE__ */ React.createElement("g", { transform: `translate(0, ${topPad})` }, /* @__PURE__ */ React.createElement("rect", { x: MARGIN.left, y: MARGIN.top, width: w, height: h, fill: plotBg || "#fff" }), showGrid && yTicks.map((t) => /* @__PURE__ */ React.createElement(
      "line",
      {
        key: t,
        x1: MARGIN.left,
      ...
      (p) => p.areaD ? /* @__PURE__ */ React.createElement(
        "path",
        {
          key: `area-${p.prefix}`,
          d: p.areaD,
      ...
      (p) => p.lineD ? /* @__PURE__ */ React.createElement(
        "path",
        {
          key: `line-${p.prefix}`,
          d: p.lineD,
    ...
    ), xTicks.map((t) => /* @__PURE__ */ React.createElement("g", { key: t }, /* @__PURE__ */ React.createElement(
      "line",
      {
        x1: sx(t),
        x2: sx(t),
      ...
      t % 1 === 0 ? t : t.toFixed(1)
    ))), xLabel && /* @__PURE__ */ React.createElement(
      "text",
      {
        x: MARGIN.left + w / 2,
        y: vbH - 4,
...
const InsetBarplot = forwardRef(function InsetBarplot2({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("g", { transform: `translate(0, ${topPad})` }, /* @__PURE__ */ React.createElement("rect", { x: M.left, y: M.top, width: w, height: h, fill: plotBg || "#fff" }), insetShowGrid && yTicks.map((t) => /* @__PURE__ */ React.createElement(
      "line",
      {
        key: t,
        x1: M.left,
      ...
      ), insetErrorType !== "none" && errVal > 0 && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
        "line",
        {
          x1: bx(i),
          x2: bx(i),
      ...
      )), absAngle === 0 ? /* @__PURE__ */ React.createElement(
        "text",
        {
          x: bx(i),
          y: M.top + h + 12,
...
const PlotPanel = React.forwardRef(function PlotPanel2({
  ...
  if (activeStats.length === 0)
    return /* @__PURE__ */ React.createElement("div", { style: { padding: "60px 20px", textAlign: "center", color: "#999", fontSize: 14 } }, "No conditions or samples selected. Enable at least one to display the plot.");
  const insetBarProps = {
    series,
    insetColors,
    insetStrokeColors,
  ...
  const BarTiles = showInset ? /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 16, marginTop: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", gap: 10 } }, /* @__PURE__ */ React.createElement(
    "div",
    {
      style: {
        borderRadius: 10,
    ...
    /* @__PURE__ */ React.createElement("p", { style: { margin: "0 0 8px", fontSize: 12, fontWeight: 600, color: "#1d4ed8" } }, "\u03A3 Raw"),
    /* @__PURE__ */ React.createElement(
      InsetBarplot,
      {
        ref: insetBarRef,
  ...
  ), replicateSums && replicateSums.length > 0 && /* @__PURE__ */ React.createElement(
    "div",
    {
      style: {
        borderRadius: 10,
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("p", { style: { margin: 0, fontSize: 12, fontWeight: 600, color: "#1d4ed8" } }, "\u03A3 Raw \u2014 per replicate"),
      /* @__PURE__ */ React.createElement(
        "button",
        {
          onClick: (e) => {
            const rows = replicateSums.flatMap(
              (rs) => rs.repSums.map((rep, ri) => [
                rs.prefix,
                `Rep ${ri + 1}`,
    ...
    /* @__PURE__ */ React.createElement("table", { style: { borderCollapse: "collapse", fontSize: 11, width: "100%" } }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", { style: { borderBottom: "2px solid #bfdbfe" } }, ["Condition", "Replicate", "Raw Sum"].map((h) => /* @__PURE__ */ React.createElement(
      "th",
      {
        key: h,
        style: {
      ...
      h
    )))), /* @__PURE__ */ React.createElement("tbody", null, replicateSums.map(
      (rs) => rs.repSums.map((rep, ri) => /* @__PURE__ */ React.createElement("tr", { key: `${rs.prefix}-${ri}`, style: { borderBottom: "1px solid #dbeafe" } }, /* @__PURE__ */ React.createElement("td", { style: { padding: "3px 8px", color: "#334155", fontWeight: 600 } }, rs.label), /* @__PURE__ */ React.createElement("td", { style: { padding: "3px 8px", color: "#64748b" } }, "Rep ", ri + 1), /* @__PURE__ */ React.createElement("td", { style: { padding: "3px 8px", color: "#1e40af", fontFamily: "monospace" } }, rep.rawSum != null ? rep.rawSum.toFixed(4) : "\u2014")))
    )))
  )), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", gap: 10 } }, /* @__PURE__ */ React.createElement(
    "div",
    {
      style: {
        borderRadius: 10,
    ...
    /* @__PURE__ */ React.createElement("p", { style: { margin: "0 0 8px", fontSize: 12, fontWeight: 600, color: "#0f766e" } }, "\u03A3 Baseline-corrected"),
    /* @__PURE__ */ React.createElement(
      InsetBarplot,
      {
        ref: insetBarCorrRef,
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("p", { style: { margin: 0, fontSize: 12, fontWeight: 600, color: "#0f766e" } }, "\u03A3 Baseline-corrected \u2014 per replicate"),
      /* @__PURE__ */ React.createElement(
        "button",
        {
          onClick: (e) => {
    ...
    /* @__PURE__ */ React.createElement("table", { style: { borderCollapse: "collapse", fontSize: 11, width: "100%" } }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", { style: { borderBottom: "2px solid #99f6e4" } }, ["Condition", "Replicate", "Corrected Sum"].map((h) => /* @__PURE__ */ React.createElement(
      "th",
      {
        key: h,
        style: {
      ...
      (rs) => rs.repSums.map((rep, ri) => /* @__PURE__ */ React.createElement("tr", { key: `${rs.prefix}-${ri}`, style: { borderBottom: "1px solid #ccfbf1" } }, /* @__PURE__ */ React.createElement("td", { style: { padding: "3px 8px", color: "#334155", fontWeight: 600 } }, rs.label), /* @__PURE__ */ React.createElement("td", { style: { padding: "3px 8px", color: "#64748b" } }, "Rep ", ri + 1), /* @__PURE__ */ React.createElement("td", { style: { padding: "3px 8px", color: "#0f766e", fontFamily: "monospace" } }, rep.corrSum != null ? rep.corrSum.toFixed(4) : "\u2014")))
    )))
  ))) : null;
  if (faceted) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      displaySeries.map((s) => /* @__PURE__ */ React.createElement(
        "div",
        {
          key: s.prefix,
          style: { display: "flex", alignItems: "center", gap: 6, fontSize: 12, color: "#444" }
        },
        /* @__PURE__ */ React.createElement("div", { style: { width: 16, height: 4, background: s.color, borderRadius: 2 } }),
        s.label,
        " ",
        /* @__PURE__ */ React.createElement("span", { style: { color: "#999" } }, "number of repeats used = ", s.n)
      ))
    )
  ), BarTiles);
});
function ConditionEditor({ conditions, onChange }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 5 } }, conditions.map((c, i) => /* @__PURE__ */ React.createElement(
    "div",
    {
      key: c.prefix,
      style: {
    ...
    /* @__PURE__ */ React.createElement(ColorInput, { value: c.color, onChange: (v) => update(i, "color", v), size: 20 }),
    /* @__PURE__ */ React.createElement(
      "input",
      {
        value: c.label,
...
function HowToSection() {
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { color: "#fff", fontWeight: 700, fontSize: 15 } }, "Aequorin Ca\xB2\u207A Calibration \u2014 How to use"), /* @__PURE__ */ React.createElement("div", { style: { color: "rgba(255,255,255,0.75)", fontSize: 11, marginTop: 2 } }, "RLU \u2192 [Ca\xB2\u207A] \u2022 Raw or calibrated \u2022 Time-course plotting \u2022 \u03A3 barplots"))
    ),
    /* @__PURE__ */ React.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, color: "#555", marginBottom: 8, lineHeight: 1.6 } }, "Each ", /* @__PURE__ */ React.createElement("strong", null, "column"), " = one sample/replicate. Each ", /* @__PURE__ */ React.createElement("strong", null, "row"), " = one time-point. First row = header names."),
        /* @__PURE__ */ React.createElement("table", { style: { borderCollapse: "collapse", fontSize: 11, width: "100%" } }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", { style: { background: "#dbeafe" } }, ["WT", "WT", "WT", "KO", "KO", "KO"].map((h, i) => /* @__PURE__ */ React.createElement(
          "th",
          {
            key: i,
            style: {
      ...
      /* @__PURE__ */ React.createElement(
        ...
        [
        ...
        ].map(({ icon, text }) => /* @__PURE__ */ React.createElement(
          "div",
          {
            key: icon,
          ...
          /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#444", lineHeight: 1.55 } }, text)
        ))
      ),
      /* @__PURE__ */ React.createElement(
        "div",
      ...
      /* @__PURE__ */ React.createElement(
        ...
        [
          ...
          {
            icon: "\u{1F500}",
            text: "Switch between Pool (group by header name, mean \xB1 SD) and Individual (each column plotted separately as name_rep1, name_rep2\u2026)."
          },
          {
            icon: "\u26A1",
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, fontWeight: 700, color: "#3b6cf7" } }, "\u{1F4A1} Replicate grouping \u2014", " "),
        /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#444" } }, "In Pool mode, columns sharing the same header name are grouped: mean \xB1 SD is computed across them at each time-point. In Individual mode, each column is its own condition (labelled name_rep1, name_rep2\u2026) and plotted separately.")
      ),
...
function ConfigureStep({
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 16, marginBottom: 16, alignItems: "stretch" } }, /* @__PURE__ */ React.createElement("div", { style: { ...sec, flex: "1 1 0", marginBottom: 0 } }, /* @__PURE__ */ React.createElement("p", { style: { margin: "0 0 8px", fontSize: 13, fontWeight: 600, color: "#555" } }, "Calibration formula"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 16, flexWrap: "wrap", alignItems: "flex-end" } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Formula"), /* @__PURE__ */ React.createElement("select", { value: formula, onChange: (e) => setFormula(e.target.value), style: selStyle }, /* @__PURE__ */ React.createElement("option", { value: "none" }, "None (raw data)"), /* @__PURE__ */ React.createElement("option", { value: "allen-blinks" }, "Allen & Blinks (1978)"), /* @__PURE__ */ React.createElement("option", { value: "hill" }, "Hill equilibrium"), /* @__PURE__ */ React.createElement("option", { value: "generalized" }, "Generalised Allen & Blinks"))), (formula === "allen-blinks" || formula === "generalized") && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Kr"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "number",
      value: Kr,
  ...
  )), (formula === "allen-blinks" || formula === "generalized") && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Ktr"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "number",
      value: Ktr,
  ...
  )), formula === "hill" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Kd (\xB5M)"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "number",
      value: Kd,
  ...
  )), formula === "generalized" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "n (Hill exp.)"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "number",
      value: hillN,
  ...
  )), parsed && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#888", paddingBottom: 4 } }, "Range: 0 \u2013 ", (parsed.data.length * vis.timeStep).toFixed(3), " ", vis.baseUnit)))), /* @__PURE__ */ React.createElement("div", { style: sec }, /* @__PURE__ */ React.createElement(
    "div",
    {
      style: {
        display: "flex",
    ...
    /* @__PURE__ */ React.createElement("p", { style: { margin: 0, fontSize: 13, color: "#666" } }, "Loaded ", /* @__PURE__ */ React.createElement("strong", { style: { color: "#333" } }, fileName), " \u2014 ", parsed.headers.length, " ", "samples \xD7 ", parsed.data.length, " time-points"),
    /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: (e) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { marginTop: 8 } }, /* @__PURE__ */ React.createElement("p", { style: { margin: "0 0 6px", fontSize: 12, fontWeight: 600, color: "#555" } }, "Preview \u2014 ", formula === "none" ? "raw data" : "calibrated data", " \xB7 ", ei.length, " of", " ", parsed.headers.length, " columns (first 15 rows):"), /* @__PURE__ */ React.createElement(
      DataPreview,
      {
...
function PlotControls({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: sec }, /* @__PURE__ */ React.createElement("p", { style: { margin: "0 0 8px", fontSize: 13, fontWeight: 600, color: "#555" } }, "Conditions"), /* @__PURE__ */ React.createElement(ConditionEditor, { conditions, onChange: setConditions }), /* @__PURE__ */ React.createElement("details", { style: { marginTop: 8, fontSize: 11, color: "#999" } }, /* @__PURE__ */ React.createElement("summary", { style: { cursor: "pointer" } }, "Debug: column grouping"), /* @__PURE__ */ React.createElement(
      "pre",
      {
        style: {
          whiteSpace: "pre-wrap",
      ...
      stats.map(
        (c) => `"${c.prefix}" \u2192 ${c.colIndices.length} replicate(s) (col indices: ${c.colIndices.join(", ")})`
      ).join("\n")
    ))),
    /* @__PURE__ */ React.createElement("div", { style: sec }, /* @__PURE__ */ React.createElement("p", { style: { margin: "0 0 8px", fontSize: 13, fontWeight: 600, color: "#555" } }, "Plot parameters"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "X start"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "number",
        value: vis.xStart,
    ...
    )), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "X end"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "number",
        value: vis.xEnd,
    ...
    )), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Y min"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "number",
        value: vis.yMin,
    ...
    )), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Y max"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "number",
        value: vis.yMax,
    ...
    ), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Title"), /* @__PURE__ */ React.createElement(
      "input",
      {
        value: vis.plotTitle,
    ...
    )), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Subtitle"), /* @__PURE__ */ React.createElement(
      "input",
      {
    ...
    /* @__PURE__ */ React.createElement("div", { style: sec }, /* @__PURE__ */ React.createElement("p", { style: { margin: "0 0 8px", fontSize: 13, fontWeight: 600, color: "#555" } }, "Style"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, /* @__PURE__ */ React.createElement(
      BaseStyleControls,
      {
        plotBg: vis.plotBg,
    ...
    ), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Display unit"), /* @__PURE__ */ React.createElement(
      "select",
      {
    ...
    /* @__PURE__ */ React.createElement("div", { style: sec }, /* @__PURE__ */ React.createElement("p", { style: { margin: "0 0 10px", fontSize: 13, fontWeight: 600, color: "#555" } }, "Barplot (\u03A3 of plotted values)"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 10 } }, /* @__PURE__ */ React.createElement("span", { style: lbl }, "Show"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "checkbox",
    ...
    )), vis.showInset && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
      "p",
      {
        style: {
          margin: "0 0 6px",
      ...
      "Layout"
    ), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8, marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Width"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "number",
        value: vis.insetW,
    ...
    )), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement("span", { style: lbl }, "Grid"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "checkbox",
    ...
    )), vis.insetShowGrid && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Grid color"), /* @__PURE__ */ React.createElement(
      ColorInput,
      {
      ...
      "Bars"
    ), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8, marginBottom: 12 } }, /* @__PURE__ */ React.createElement(
      SliderControl,
      {
        label: "Fill opacity",
      ...
      "Error bars"
    ), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8, marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Type"), /* @__PURE__ */ React.createElement(
      "select",
      {
    ...
    )), vis.insetErrorType !== "none" && /* @__PURE__ */ React.createElement(
      SliderControl,
      {
      ...
      "Condition colors"
    ), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, stats.filter((s) => s.enabled).map((s) => /* @__PURE__ */ React.createElement(
      "div",
      {
        key: s.prefix,
        style: {
      ...
      /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#555", fontWeight: 600, marginBottom: 6 } }, s.label),
      /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 4 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#999", width: 28 } }, "fill"), /* @__PURE__ */ React.createElement(
        ColorInput,
        {
...
function SampleSelectionOverlay({
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { position: "sticky", top: 0, zIndex: 20, marginBottom: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { position: "relative", display: "inline-block" } }, /* @__PURE__ */ React.createElement(
  ...
  ), showColumnOverlay && /* @__PURE__ */ React.createElement(
    "div",
    {
      style: {
        position: "absolute",
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("p", { style: { margin: 0, fontSize: 12, fontWeight: 600, color: "#555" } }, "Column grouping"),
      /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4 } }, [
        { val: true, label: "Pool by name" },
        { val: false, label: "Individual" }
      ].map(({ val, label }) => /* @__PURE__ */ React.createElement(
        "button",
        {
          key: label,
    ...
    /* @__PURE__ */ React.createElement(
      ...
      (() => {
        ...
        return groups.map((g) => /* @__PURE__ */ React.createElement(
          "div",
          {
            key: g.name,
            style: {
          ...
          /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 3 } }, g.cols.map(({ h, i, rep }) => {
...
function App() {
  ...
  const stats = useMemo(
    () => calData && parsed && conditions.length > 0 ? computeCalStats(calData, parsed.headers, conditions) : [],
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    parseError && /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          marginBottom: 16,
      ...
      !parseError.startsWith("\u26A0\uFE0F") && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 16 } }, "\u{1F6AB}"),
      /* @__PURE__ */ React.createElement(
        "span",
        {
          style: {
    ...
    step === "plot" && parsed && calData && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 12, marginBottom: 16, alignItems: "center" } }, /* @__PURE__ */ React.createElement(
      "button",
      {
