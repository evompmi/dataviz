...
const BoxplotChart = forwardRef(function BoxplotChart2({
  ...
  const renderCompPie = (g, lx) => {
    ...
    const slices = g.sources.map((src, si) => {
      ...
      if (pct >= 1)
        return /* @__PURE__ */ React.createElement("circle", { key: si, cx: lx, cy: cy2, r, fill: col, stroke: "#000", strokeWidth: "0.5" });
    ...
    return /* @__PURE__ */ React.createElement("g", { key: `cb-${g.name}` }, slices, /* @__PURE__ */ React.createElement("circle", { cx: lx, cy: cy2, r, fill: "none", stroke: "#000", strokeWidth: "0.5" }), labels);
  };
  return /* @__PURE__ */ React.createElement(
    "svg",
    {
    ...
    yTicks.map((t) => /* @__PURE__ */ React.createElement("g", { key: t }, /* @__PURE__ */ React.createElement("line", { x1: M.left - 5, x2: M.left, y1: sy(t), y2: sy(t), stroke: "#333", strokeWidth: "1" }), /* @__PURE__ */ React.createElement(
      "text",
      {
        x: M.left - 8,
        y: sy(t) + 4,
    ...
    groups.map((g, gi) => {
      ...
      if (isViolin && g.allValues.length >= 2) {
        ...
        if (maxD > 0) {
          ...
          if (isRain) {
            ...
            violinPath = /* @__PURE__ */ React.createElement(
              "path",
              {
                d,
                fill: g.color,
      ...
      const boxEls = /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("line", { x1: boxCx, x2: boxCx, y1: sy(wHi), y2: sy(q3), stroke: "#333", strokeWidth: "1" }), /* @__PURE__ */ React.createElement("line", { x1: boxCx, x2: boxCx, y1: sy(q1), y2: sy(wLo), stroke: "#333", strokeWidth: "1" }), /* @__PURE__ */ React.createElement(
        "line",
        {
      ...
      const outlierEls = g.sources.flatMap(
        (src, si) => src.values.filter((v) => v < wLo || v > wHi).map((v, oi) => /* @__PURE__ */ React.createElement(
          "circle",
          {
...
function UploadStep({ sepOverride, onSepChange, rawText, doParse, handleFileLoad, setStep }) {
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { color: "#fff", fontWeight: 700, fontSize: 15 } }, "Boxplot \u2014 How to use"), /* @__PURE__ */ React.createElement("div", { style: { color: "rgba(255,255,255,0.75)", fontSize: 11, marginTop: 2 } }, "Long or wide data \u2192 auto-detect \u2192 customizable boxplots"))
    ),
    /* @__PURE__ */ React.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, color: "#555", marginBottom: 8, lineHeight: 1.6 } }, "Each ", /* @__PURE__ */ React.createElement("strong", null, "row"), " = one observation. Columns mix categorical labels and numeric values."),
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, color: "#555", marginBottom: 8, lineHeight: 1.6 } }, "One ", /* @__PURE__ */ React.createElement("strong", null, "column"), " per condition. All values numeric. Headers = group names.", " ", /* @__PURE__ */ React.createElement("strong", null, "Goes straight to plot.")),
        /* @__PURE__ */ React.createElement("table", { style: { borderCollapse: "collapse", fontSize: 11, width: "100%" } }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", { style: { background: "#d1fae5" } }, ["WT", "WT", "mutA", "mutB"].map((h, i) => /* @__PURE__ */ React.createElement(
          "th",
          {
            key: i,
            style: {
      ...
      /* @__PURE__ */ React.createElement(
        ...
        [
          ...
          { icon: "\u{1F3A8}", text: "Plot: color-by, facet-by, jitter controls, and SVG download." }
      ...
      /* @__PURE__ */ React.createElement(
        ...
        ].map(({ step, text }) => /* @__PURE__ */ React.createElement("div", { key: step, style: { display: "flex", gap: 8, alignItems: "flex-start" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, fontWeight: 700, color: "#E07B39", flexShrink: 0 } }, step), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#444", lineHeight: 1.55 } }, text))))
      ),
      /* @__PURE__ */ React.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, color: "#555", marginBottom: 8, lineHeight: 1.6 } }, "Use the ", /* @__PURE__ */ React.createElement("strong", null, "Plot style"), " dropdown in the style controls to switch between three visualization modes:"),
        /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 5 } }, [
          {
            step: "Box",
            text: "Classic box-and-whisker plot. Median line, IQR box, 1.5\xD7IQR whiskers, outlier dots."
          },
          {
            step: "Violin",
        ...
        ].map(({ step, text }) => /* @__PURE__ */ React.createElement("div", { key: step, style: { display: "flex", gap: 8, alignItems: "flex-start" } }, /* @__PURE__ */ React.createElement(
          "span",
          {
            style: {
              fontSize: 11,
        ...
        /* @__PURE__ */ React.createElement(
          ...
          "All styles support color-by, facet-by, and outlier dots. The Y-axis auto-adjusts to fit the violin/raincloud density curves."
        )
      ),
      /* @__PURE__ */ React.createElement(
        "div",
        ...
        /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#444" } }, "Wide-format files (like the output of the Bar Graph or Aequorin tools) are auto-detected and go straight to plot. For long-format, you can facet by one column while coloring points by another.")
      ),
...
function OutputStep({
  ...
  return /* @__PURE__ */ React.createElement("div", null, groupColIdx >= 0 && valueColIdx >= 0 && stats.length > 0 && /* @__PURE__ */ React.createElement(StatsTable, { stats, groupLabel: colNames[groupColIdx] }), /* @__PURE__ */ React.createElement("div", { style: sec }, /* @__PURE__ */ React.createElement(
    "div",
    {
      style: {
        display: "flex",
...
function PlotControls({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    dataFormat === "wide" && /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 15 } }, "\u26A1"), /* @__PURE__ */ React.createElement("p", { style: { margin: 0, fontSize: 11, color: "#065f46", fontWeight: 600 } }, "Wide format auto-detected")),
      /* @__PURE__ */ React.createElement(
        "button",
        {
          onClick: () => {
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Plot style"), /* @__PURE__ */ React.createElement(
        "select",
        {
          value: vis.plotStyle,
        ...
        /* @__PURE__ */ React.createElement("option", { value: "box" }, "Box plot"),
        /* @__PURE__ */ React.createElement("option", { value: "violin" }, "Violin plot"),
        /* @__PURE__ */ React.createElement("option", { value: "raincloud" }, "Raincloud plot")
      )),
      /* @__PURE__ */ React.createElement(
        BaseStyleControls,
        {
      ...
      /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("span", { style: lbl }, "Points"), /* @__PURE__ */ React.createElement(
        "input",
        {
          type: "checkbox",
      ...
      vis.showPoints && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Color by"), /* @__PURE__ */ React.createElement(
        "select",
        {
          value: colorByCol,
        ...
        colorByCandidates.map((ci) => /* @__PURE__ */ React.createElement("option", { key: ci, value: ci }, colNames[ci]))
      )), colorByCol >= 0 && /* @__PURE__ */ React.createElement(
        "label",
        {
          style: {
            display: "flex",
        ...
        /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#555" } }, "Composition pies")
      ...
      /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: lbl }, "Facet by"), /* @__PURE__ */ React.createElement(
        "select",
        {
          value: facetByCol,
...
const FacetBoxplotItem = memo(function FacetBoxplotItem2({
  fd,
  facetRefs,
  chartProps,
  categoryColors
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 6 } }, /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          width: 10,
    ...
    ), /* @__PURE__ */ React.createElement("p", { style: { margin: 0, fontSize: 13, fontWeight: 600, color: "#333" } }, fd.category), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#999" } }, "(", fd.groups.reduce((a, g) => a + g.allValues.length, 0), " pts)")),
    /* @__PURE__ */ React.createElement(BoxplotChart, { ref: localRef, ...chartProps })
  );
});
function PlotArea({
  colorByCol,
  ...
  ), facetByCol < 0 && /* @__PURE__ */ React.createElement(
    "div",
    {
